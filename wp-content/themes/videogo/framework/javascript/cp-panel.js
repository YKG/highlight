...
jQuery(document).ready(function () {
    ...
    jQuery('#upload-btn').click(function(e) {
        ...
        .on('select', function(e){
            ...
            jQuery('#upload_image_text').val(image_url);
            jQuery('#upload_image_attachment_id').val(image_id);
        });
    });
    // Mini Color
    ...
    jQuery('.upload_retina_image_button').click(function(e) {
        e.preventDefault(); 
        var image = wp.media({ 
            title: 'Upload Image',
            // mutiple: true if you want to upload multiple files at once
        ...
        .on('select', function(e){
            ...
            var image_id = uploaded_image.toJSON().id;
            // Let's assign the url value to the input field
            jQuery('#upload_retina_image_text').val(image_url);
            jQuery('#upload_retina_image_attachment_id').val(image_id);
        });
    });


    jQuery('.upload_footer_image_button').click(function(e) {
        e.preventDefault(); 
        var image = wp.media({ 
            title: 'Upload Image',
            // mutiple: true if you want to upload multiple files at once
        ...
        .on('select', function(e){
            ...
            var image_id = uploaded_image.toJSON().id;
            // Let's assign the url value to the input field
            jQuery('#upload_footer_image_text').val(image_url);
            jQuery('#upload_footer_image_attachment_id').val(image_id);
        });
    });
    ...
    jQuery("a#add-more-data").click(function () {
		...
		//alert(clone_item);
		var clone_field_name = jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_field_name').val();
		var clone_field_val = jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_field_val').val();
        ...
        clone_item.find('input#lawyerpro_field_name').attr('value', clone_field_name);
		clone_item.find('input#lawyerpro_field_val').attr('value', clone_field_val);
		...
		jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_field_name').val('Field Name');
		jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_field_val').val('Field Value');
    });
   ...
   //End of Default Custom Field Code
	
	//Start of Second Custom Field Code
	var counter = 0;
    jQuery("a#add-more-fields").click(function () {
		var clone_item = jQuery(this).parent().parent().parent().parent().siblings('.law_bootstrap_admin').find('.cp-element-item').clone(true);
		//var clone_item = jQuery(this).parent().parent().parent().parent().siblings('.bootstrap_admin').find('.cp-element-item').html();
		//alert(clone_item);
		var clone_field_name = jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_skill_name').val();
		var clone_field_val = jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_skill_val').val();
        if (clone_field_name.indexOf("&") > 0) {
            alert('You can\'t use the special charactor ( such as & ) as the ingre name.');
            return;
        }
        ...
        clone_item.find('input#lawyerpro_skill_name').attr('value', clone_field_name);
		clone_item.find('input#lawyerpro_skill_val').attr('value', clone_field_val);
		// clone_item.find('textarea#add-more-desc').val(clone_val_des);
        clone_item.find('.panel-title').find('h3').text(clone_field_name);		
        jQuery("#add_data_fields").append(clone_item);
        jQuery(".element-item").slideDown();
		jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_skill_name').val('Field Name');
		jQuery(this).parent().parent().siblings('.span5').find('input.lawyerpro_skill_val').val('Field Value');
    });
    jQuery(".element-item").css('float', 'left');
    jQuery(".panel-delete-field").click(function () {
        var deleted_sidebar = jQuery(this);
    ...
    jQuery("input.upload-font-button").click(function () {
        ...
        font_name_box = jQuery(this).parents('#font-item').find(".lawyerpro_upload_font_name");
    ...
    jQuery(".font_google").change(function () {
		...
		if(select_object_type == 'ADOBE EDGE FONT'){
			var sample_text = selected_combobox.parent().parent().parent().find("#option-font-sample");
				...
				jQuery.post(ajaxurl, {
					action: 'get_lawyerpro_typekit_url',
	...
	jQuery("#header_logo_cp div.checkbox-switch").click(function () {
        if (jQuery(this).hasClass('checkbox-switch-on')) {
			jQuery(this).parent().parent().parent().parent().find('.lawyerpro_logo_text').addClass('default-slider-hide');
			jQuery(this).parent().parent().parent().parent().parent().find('.lawyerpro_logo').removeClass('default-slider-hide');
        } else {
			jQuery(this).parent().parent().parent().parent().find('.lawyerpro_logo_text').removeClass('default-slider-hide');
			jQuery(this).parent().parent().parent().parent().parent().find('.lawyerpro_logo').addClass('default-slider-hide');
        }
    });
	...
	if (jQuery('#header_logo_cp .header_logo_btn label div').hasClass('checkbox-switch-on')) {
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().find('.lawyerpro_logo_text').addClass('default-slider-hide');
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().parent().find('.lawyerpro_logo').removeClass('default-slider-hide');
	} else {
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().find('.lawyerpro_logo_text').removeClass('default-slider-hide');
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().parent().find('.lawyerpro_logo').addClass('default-slider-hide');
	}
    ...
    jQuery('.radio-image-wrapper input').change(function () {
        ...
        if (jQuery(this).val() == 'right-sidebar') {
            panel_body.find('.lawyerpro_right_sidebar').removeClass('default-slider-hide');
            panel_body.find('.lawyerpro_left_sidebar').addClass('default-slider-hide');
        } else if (jQuery(this).val() == 'left-sidebar') {
            panel_body.find('.lawyerpro_right_sidebar').addClass('default-slider-hide');
            panel_body.find('.lawyerpro_left_sidebar').removeClass('default-slider-hide');
	...
	//Category Layout Selection
	    jQuery('#cat_layout').change(function () {
        var selected_class = jQuery("#cat_layout option:selected").attr("class");	
		jQuery('.category_image_cp').slideUp();
		jQuery('#'+selected_class).slideDown();
	...
	//Slider theme options drop down ingenio
    jQuery('#select_slider').change(function () {
        var option_class = jQuery("#select_slider option:selected").attr("class");
        if (option_class == 'bx_slider') {
            jQuery('.bx_slider_box').slideDown();
			jQuery('.video_slider').slideUp();
           // jQuery('.anything_slider_box').slideUp();
        } else if (option_class == 'video_banner') {
            jQuery('.bx_slider_box').slideUp();
            jQuery('.video_slider').slideDown();
            //jQuery('.anything_slider_box').slideUp();
        } else if (option_class == 'default') {
            jQuery('.bx_slider_box').hide();
    ...
    if (selected_class == 'layer_slider') {
        ...
        jQuery('.lawyerpro_select_slider').slideDown();
    }
    //Slider theme options drop down
    jQuery('#home_select_slider').change(function () {
        ...
        if (option_class == 'layer_slider') {
            jQuery('.layer_slider_shortcode').slideDown();
            jQuery('.lawyerpro_select_slider').slideUp();
        } else {
            jQuery('.layer_slider_shortcode').slideUp();
            jQuery('.lawyerpro_select_slider').slideDown();
        }
    ...
    //background combobox
    jQuery('#lawyerpro_background_style').change(function () {
        if (jQuery(this).val() == 'Pattern') {
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_pattern').removeClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_custom').addClass('default-slider-hide');
        } else if (jQuery(this).val() == 'Custom Image') {
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_pattern').addClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_custom').removeClass('default-slider-hide');
        } else {
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_pattern').addClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_custom').addClass('default-slider-hide');
        }
    });
    jQuery('#lawyerpro_background_style').each(function () {
        if (jQuery(this).val() == 'Pattern') {
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_pattern').removeClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-lawyerpro_background_custom').addClass('default-slider-hide');
        } else if (jQuery(this).val() == 'Custom Image') {
