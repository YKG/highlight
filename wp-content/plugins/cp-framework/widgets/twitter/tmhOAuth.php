...
class tmhOAuth {
  ...
  public function __construct($config=array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'videogo_consumer_key'               => '',
        'videogo_consumer_secret'            => '',
        'user_token'                 => '',
        'user_secret'                => '',
        'force_nonce'                => false,
  ...
  private function get_defaults() {
    $defaults = array(
      ...
      'oauth_consumer_key'     => $this->config['videogo_consumer_key'],
  ...
  private function prepare_signing_key() {
    $this->signing_key = $this->safe_encode($this->config['videogo_consumer_secret']) . '&' . $this->safe_encode($this->config['user_secret']);
  }
