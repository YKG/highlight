...
if(class_exists('videogo_function_library')){
	...
	class videogo_shortcode extends videogo_function_library{
		...
		public $div_start = array(
			...
			"repeat" => array(
				...
				'options'=>array('0'=>'no-repeat', '1'=>'repeat'),
		...
		global $page_meta_boxes;
			...
			$page_meta_boxes['Page Item']['name']['Sidebar']['sidebar-layout-select']['options'] = videogo_get_sidebar_name();
	...
	$videogo_shortcode = new videogo_shortcode;
}
